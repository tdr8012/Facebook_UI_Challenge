...
This is a mobile application developed as part of the **C2_IOS MOBILE DEVELOPMENT II** course at LaSalle College, Winter 2025. The application demonstrates the ability to re-create a Facebook-like UI using Swift and XCode.
...
- **Registration**: Generates account as a new user.
